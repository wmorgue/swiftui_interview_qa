...
Оба массива ссылаются на один указатель в памяти `5519730800`. Попробуем добавить новый эелемент в `secondArr`:
...
Это избаляет программу от лишних копирований, тем самым улучшая производительность.
